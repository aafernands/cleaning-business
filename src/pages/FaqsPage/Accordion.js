    ...
    <div>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary
          ...
          id="panel2bh-header"
        >
          <Typography sx={{ width: '33%', flexShrink: 0 }}>Do I have to do anything before you come to clean?</Typography>
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        <AccordionSummary
          ...
          id="panel4bh-header"
        >
          <Typography sx={{ width: '33%', flexShrink: 0 }}>What if I need to Cancel the service?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
        <AccordionSummary
          ...
          id="panel5bh-header"
        >
          <Typography sx={{ width: '33%', flexShrink: 0 }}>What are the payment options?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
